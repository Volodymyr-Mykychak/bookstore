...
public class OrderController implements UserContextHelper {
    ...
    @Operation(summary = "Get user order history", description = "Return list of all orders of "
            + "user")
    @GetMapping
    ...
    @Operation(summary = "Create order", description = "Create order from current shopping cart "
            + "items")
    @PostMapping
    ...
    @Operation(summary = "Update order status", description = "Admin only: Updates the order "
            + "status")
    @PutMapping("/{orderId}")
    ...
    @Operation(summary = "Get all order items", description = "Get list of all items in specific "
            + "order")
    ...
    @Operation(summary = "Get order item by id", description = "Get specific item details from "
            + "specific order")
    ...
    @Operation(summary = "Get order details", description = "Get full information about a "
            + "specific order")
    @GetMapping("/{orderId}")
    ...
    @Operation(summary = "Get all orders for admin", description = "Admin only: get all orders "
            + "in" + " system")
    @GetMapping("/admin")
    @PreAuthorize("hasRole('ADMIN')")
